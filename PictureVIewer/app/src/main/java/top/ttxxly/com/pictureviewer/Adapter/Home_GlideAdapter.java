...
public class Home_GlideAdapter extends BaseAdapter {

    private String Url = "http://10.0.2.2/picture_viewer";

    List<Photos.PhotosBean> photosBeanList;
    public Home_GlideAdapter(List<Photos.PhotosBean> photosBeanList) {
        this.photosBeanList = photosBeanList;
        Log.i("首页GlideAdapter数量", ""+photosBeanList.size());
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        * */
        Log.i("首页glideAdapter_url", Url + photosBeanList.get(position).getUrl());
